...
"
            ...
            <div className="mt-3">
              ...
              <div className="p-[8px] border-[#D9D9D9] border-solid border-[1px] rounded-xl py-2 mt-1">
                <input id="donorName" type="text" name="donorName" placeholder="مروان طارق" />
              </div>
            </div>
            <div className="mt-3">
              <label htmlFor="MobileNumber">رقم الهاتف</label>
              <div className="p-[8px] border-[#D9D9D9] border-solid border-[1px] rounded-xl py-2 mt-1">
                <input id="MobileNumber" type={"tel"} placeholder="010123456789" name="teleNumber"/>
              </div>
            </div>
            <button className="w-full bg-red-500 py-[11px] rounded-[20px] text-white mt-10" type="submit">حفظ</button>
          </div>
        </form>
        <div className="lg:w-[54%] lg:block hidden">
          <img className="w-full h-full" src={DonorImage} alt="DonorImage" />
        </div>
      </div>
      <Footer/>
    </div>
