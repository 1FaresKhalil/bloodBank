    ...
    <div id="Need-blood">
      ...
      <div className="container mx-auto min-h-[749px] shadow-md rounded-[10px] flex justify-center pt-[117px]">
        <form action="">
          ...
          <div className="mt-3">
            <label className="text-center w-full block" htmlFor="city">المحافظة</label>
...
"
            ...
            <button className="block mx-auto bg-red-500 py-[6px] px-[29px] rounded-[20px] text-white mt-10" type="submit">بحث</button>
        </form>
      </div>
      <Footer/>
    </div>
