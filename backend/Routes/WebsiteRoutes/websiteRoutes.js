...
function WebsiteRoutes(websiteApp) {
  ...
  websiteApp.put(
    "/bloodRequest/done/:id",
    blood_request_controller.markBloodRequestAsDone
  );
  websiteApp.put(
    "/bloodRequest/:id",
    blood_request_controller.updateBloodRequestInfo
  );
  websiteApp.delete(
    "/bloodRequest/:id",
    blood_request_controller.deleteBloodRequest
  );
  websiteApp.get("/bloodRequest", blood_request_controller.getAllBloodRequests);
  websiteApp.get(
    "/bloodRequest/:id",
    blood_request_controller.getBloodRequestByID
  );
  websiteApp.get(
    "/sameBloodType/bloodRequest",
    blood_request_controller.getAllBloodRequestsWithSameBloodType
  );
  ...
  websiteApp.get(
    "/conversation/:userId",
    conversation_controller.getConversationOfUser
  );
  websiteApp.get(
    "/conversation/find/:firstUserId/:secondUserId",
    conversation_controller.getConversationOfTwoUsers
  );
  //chat messages
  websiteApp.post("/message", message_controller.addMessage);
  websiteApp.get(
    "/message/:conversationId",
    message_controller.getMessagesOfConversation
  );
}
